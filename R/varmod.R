...
#'
#' \code{varmod} calculates experimental variograms. THis process is suited to
...
varmod <- function(
  ...
  # Build list of experimental files and variogram ID numbers.
